# Spectral Library Building: Repository-Scale Library
...
$dda_repo_name = "fissionyeast_lab"
$dda_repo_psm_file = "pGlycoDB-GP-FDR-Pro.txt"
$library_prior_name = "fissionyeast"
$library_prior_main_name = "fissionyeast_6h"
$library_prior_rtcalibrate_name = "fissionyeast_1h"
$library_name = "fissionyeast_lab"
...
$dda_repo_name = "serum_lab"
$dda_repo_psm_file = "pGlycoDB-GP-FDR-Pro.txt"
$library_prior_name = "serum"
$library_prior_main_name = "serum_fraction"
$library_prior_rtcalibrate_name = "serum_1h"
$library_name = "serum_lab"
$library_pqp_file = "$($library_name)_uis.PQP"
$swath_window_file = "..\swath_window.tsv"
$background_glycan_file = "..\background_glycan.txt"
$enable_glycoform_inference = $true
$rtcalibrate_lowess_frac = 0.25
$rtcalibrate_lowess_it = 0
$library_min_fragment_mz = 200
$library_max_fragment_mz = 2000
...
--clean_glycan_struct `
--clean_glycan_site `
--psm "$data_path\DDA\$dda_repo_name\$dda_repo_psm_file" `
--mgf (ls "$data_path\DDA\$dda_repo_name\" *.mgf | select -ExpandProperty FullName) `
--out "$data_path\library\$library_name\$dda_repo_name.assay.pickle" 

# Build consensus assays
python "$script_path\remove_redundant_assays.py" `
--within_run `
--action consensus `
--in "$data_path\library\$library_name\$dda_repo_name.assay.pickle" `
--out "$data_path\library\$library_name\$($dda_repo_name)_consensus.assay.pickle"
...
--in "$data_path\library\$library_name\$($dda_repo_name)_consensus.assay.pickle" `
--reference "$data_path\library\$library_prior_name\$($library_prior_rtcalibrate_name)_consensus.assay.pickle" `
--out "$data_path\library\$library_name\$($dda_repo_name)_consensus_rtcalibrated.assay.pickle" `
--out_anchor "$data_path\library\$library_name\$($library_prior_rtcalibrate_name)_consensus_rtanchor.assay.pickle"

# Combine assays and remove redundant assays
python "$script_path\remove_redundant_assays.py" `
--across_run `
--action consensus `
--in "$data_path\library\$library_name\$($dda_repo_name)_consensus_rtcalibrated.assay.pickle"
...
--ignore_glycan_site `
--in "$data_path\library\$library_prior_name\$($library_prior_main_name)_consensus_rtcalibrated_consensus.assay.pickle" `
     "$data_path\library\$library_name\$($dda_repo_name)_consensus_rtcalibrated_consensus.assay.pickle" `
     "$data_path\library\$library_prior_name\$($library_prior_rtcalibrate_name)_consensus.assay.pickle" `
...
--swath_windows "$data_path\$swath_window_file" `
--min_fragment_mz $library_min_fragment_mz --max_fragment_mz $library_max_fragment_mz `
--in "$data_path\library\$library_name\$($library_prior_rtcalibrate_name)_consensus_rtanchor.assay.pickle"
...
--glycan_key composition `
--ignore_glycan_site `
--in "$data_path\library\$library_prior_name\$($library_prior_rtcalibrate_name)_consensus_rtanchor_filtered.assay.pickle" `
     "$data_path\library\$library_name\$($library_prior_rtcalibrate_name)_consensus_rtanchor_filtered.assay.pickle" `
--out "$data_path\library\$library_name\$($library_name)_combined_rtanchor_filtered.assay.pickle"

python "$script_path\convert_assays_to_traml.py" `
--in "$data_path\library\$library_name\$($library_name)_combined_rtanchor_filtered.assay.pickle" `
